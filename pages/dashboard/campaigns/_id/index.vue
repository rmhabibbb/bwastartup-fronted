       ...
       <section class="container mx-auto pt-8">
        ...
        <div class="flex justify-between items-center">
          ...
          <div class="w-1/4 text-right">
            <nuxt-link
              :to="{
                name: 'dashboard-campaigns-id-edit',
          ...
          <div class="w-full lg:max-w-full lg:flex mb-4">
            ...
            >
              <div>
                ...
                <p class="text-4xl text-gray-700">{{new Intl.NumberFormat().format(campaign.data.goal_amount)}}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="block mb-2">
          <div 
              ...
              v-for="transaction in transactions.data" :key="transaction.id"
...
export default {
  ...
  async asyncData({ $axios, params }){
    ...
    const transactions = await $axios.$get('/api/v1/campaign/' + params.id + '/transactions')
