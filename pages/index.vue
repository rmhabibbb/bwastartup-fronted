            ...
            <div class="item">
              ...
              <div class="item-meta">
                ...
                <div class="flex progress-info">
                  <div>{{ new Intl.NumberFormat().format((campaign.current_amount/campaign.goal_amount) * 100)}}%</div>
              ...
              "
                class="text-center mt-5 mb-2 button-cta block w-full bg-orange-button hover:bg-green-button text-white font-semibold px-6 py-2 text-lg rounded-full"
              >
                Fund Now
              </button>
            </div>
